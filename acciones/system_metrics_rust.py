...
class SystemMetricsRust:
    ...
    async def get_metrics(self, detailed: bool = True, processes: bool = False) -> Optional[Dict[str, Any]]:
    ...
    async def create_advanced_embed(self, guild_name: str = "OrangePi 5 Plus") -> Optional[discord.Embed]:
...
async def get_system_metrics_json() -> Optional[Dict[str, Any]]:
